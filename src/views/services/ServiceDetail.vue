  ...
  <div id="content">
    ...
    <div id="upstream-info">
      ...
      <Card>
        ...
        <div v-if="!upstreamExisted">{{ $t('service.upstreamNotExisted', {host: service.host}) }}
          <Button type="primary" size="small" @click="addUpstream(service.host)">{{ $t('common.add') }}</Button>
        </div>
        <div v-else>
          <Row>
